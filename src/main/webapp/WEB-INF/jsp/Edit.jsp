...
<div class="card">
<div class="card-body">
<h4 class="text-center text-primary">Edit
...
<form th:action="@{/update_products}"
...
<div class="mb-3">
<label
for="exampleInputEmail1" class="form-label">Enter
...
th:value="${product.decription}">

</div>
<div class="mb-3">
<label
for="exampleInputEmail1" class="form-label">price
...
<div class="mb-3">
<label
for="exampleInputEmail1" class="form-label">Quantity
...
btn-primary">Update Products</button>
</form>
</div>
</div>
</div>
